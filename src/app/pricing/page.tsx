    ...
    <AnimatedCard className={`relative p-8 transition-all duration-300 hover:scale-105 ${popular ? 'ring-2 ring-primary shadow-xl' : ''}`}>
      ...
      <div className="text-center space-y-6">
        <div className="space-y-2">
          ...
          <div className="text-5xl font-bold text-black">${plan.price}</div>
          <div className="text-black text-lg">{plan.credits} credits</div>
        </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-secondary/20">
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mt-16 pt-12 border-t border-border">
          <div className="flex justify-center items-center gap-8 text-sm text-black">
